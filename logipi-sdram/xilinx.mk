...
vhdlfiles += $(foreach core,$(xilinx_cores),$(core:.xco=.vhd))
junk += $(local_corengcs)
...
$(project).mcs: $(project).bit
	$(xil_env); \
	promgen -w -s $(flashsize) -b -p mcs -o $@ -u 0 $^
